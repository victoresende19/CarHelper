...
A demanda **Novo contexto - Moto** descreve a seguinte necessidade:

> Criar novo contexto de moto yamaha fazer 250

## História de usuário preliminar
**Como** pessoa usuária do sistema,
**quero** que a necessidade descrita em **Novo contexto - Moto** seja atendida,
